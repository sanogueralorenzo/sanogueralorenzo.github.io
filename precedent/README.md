...
- Promoted precedents must carry a typed replay receipt with replay id, path, artifact SHA-256, failure counts, and baseline/rerun exit codes; `check` rejects string-only or tampered promotion evidence.
