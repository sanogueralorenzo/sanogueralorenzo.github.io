...
- Promoted precedents must carry a typed replay receipt with replay id, path, failure counts, and baseline/rerun exit codes; `check` rejects string-only promotion evidence.
