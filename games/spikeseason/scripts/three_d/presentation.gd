...
func install_grade() -> void:
	# The world color finish leaves text and controls crisp.
	...
	grade.shader=preload("res://shaders/three_d/grade.gdshader")
	rectangle.material=grade
...
func install_light() -> void:
	...
	environment.ssil_intensity=0.25
...
func apply_season_light() -> void:
	...
	var settings:=[
		[Vector3(-16,24,-13),"ffe1ad",1.28,"bdc6c7",.40,"7eb3c4","245f9b","faf5e8",0.0],
		[Vector3(-8,32,-15),"f3ead1",1.18,"b8cbd0",.44,"80b2c0","316a9e","f4f4e9",.14],
		[Vector3(-23,16,-10),"ffd196",1.32,"c4bdc0",.42,"c49d7e","496887","fff0d1",.12],
		[Vector3(-18,26,-8),"ffe2b4",1.24,"b6c8c9",.42,"7eb3bd","2d6390","faf3e1",.05],
		[Vector3(12,29,-16),"e4e9dc",1.12,"b0c6cd",.46,"8bb2ba","3d6685","e8ede6",.25],
		[Vector3(-24,13,-18),"ffc18e",1.13,"b0b7ce",.53,"b48e84","4f567a","f8d8ba",.13],
		[Vector3(-17,26,-14),"eee5b6",1.27,"bfccb9",.42,"9abda3","497e86","f3f1d9",.10],
		[Vector3(-10,30,-16),"e5e5d0",.91,"b9c7c9",.55,"7f9d9f","596f7b","d5dbd4",.50],
		[Vector3(-22,18,-12),"ffd49b",1.30,"c3c2b7",.46,"c5a579","607c80","fff0d2",.06]
	]
