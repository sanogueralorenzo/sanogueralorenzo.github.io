...
public enum MenuGlyph { Fly, Key, Chart, Chest, Book, Home }
...
public partial class MenuButton : Button
{
    ...
    public override void _Ready()
    {
        ...
        var ink = Primary ? new Color("103b43") : MagicPalette.Cream;
    ...
    void DrawGlyph(Color ink)
    {
        ...
        {
            case MenuGlyph.Fly:
                Line(8, 33, 29, 12); Line(24, 5, 24, 12); Line(30, 9, 36, 9);
                Path(new(8, 26), new(3, 35), new(14, 31)); break;
            case MenuGlyph.Key:
