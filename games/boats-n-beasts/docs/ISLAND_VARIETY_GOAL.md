...
## Follow-up: even larger islands

The new giant tier spans radius 520–720, twice the previous maximum radius and up to four times its area for the same outline. Candidate weights are now 35% small, 35% medium, 15% large and 15% giant; the earlier three ranges and all eight seeded families remain available.

The preceding eight-neighbor proof applied to the former 360 maximum. With giants, maximum required center spacing is 1,817.6 units. Candidates two chunks apart can be only 1,400 units apart, so thinning now checks all 24 neighbors within two rings. Three chunks apart are at least 2,600 units apart and cannot conflict. A separate check protects fixed home solids. This keeps generation deterministic with bounded work and preserves 25-chunk streaming.

Additional inland rock, palm and shrub groups fill the extra area without enlarging individual props. Shore-rock counts grow with radius; beach and shallow-shelf depths stop growing beyond the previous maximum. Ruin stepping stones now use the same uniform fitting as other props, correcting oversized stones found in the first giant preview.

Native review covers all eight families at radius 720 and compares compact islands at 330/720 with the same camera and boat scale. Actual Cutter gameplay reaches a naturally generated 644.63-radius long island, checks visible shore contact and retains 25 loaded chunks through 49.2 seconds. Debug and Release pass with zero warnings/errors. [Evidence](../evidence/README.md) and [quality notes](QUALITY.md) record the captures, measurements and limits.
