...
public partial class Game : Node2D
{
    ...
    async void CaptureReview()
    {
        ...
        foreach (var enemy in Run.Enemies) report += $"Enemy {enemy.Id}: {enemy.Kind} position={enemy.Position} hp={enemy.Health:R} time={enemy.Time:R} attack={enemy.AttackClock:R} tell={enemy.Telegraph:R} dash={enemy.Dash:R} swift={enemy.Swift} speedMultiplier={enemy.SpeedMultiplier:R} fuse={enemy.Fuse:R}\n";
    ...
    public partial class Hud : Node2D
    {
        ...
        public override void _Draw()
        {
            ...
            if (r.Mode == VoyageMode.Fishing)
            {
                ...
                Text(p + new Vector2(25, 64), "Combat active · Space / E when the marker enters turquoise", 18);
