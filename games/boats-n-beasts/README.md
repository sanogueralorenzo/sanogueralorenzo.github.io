...
World generation has independent coordinate-local randomness; combat, upgrade offers, and fishing use separate streams. Each school is consumed when casting starts, so cancelling cannot retry or reroll it. Fishing holds the boat still and stops new automatic attacks, including Whirlpool and Aura pulses. Voyage time, enemies and existing projectiles keep advancing. Weapons and Aura recharge during the cast and resume after it ends. Reel or cancel to sail away. Defeat or victory ends an active cast; earned upgrades wait until the cast finishes. Distant chunks unload; school depletion survives their return. Sparse exploration history grows with visited places, while active chunks and visual caches are bounded.
...
The world uses broad matte color faces and quiet petrol-teal open water. Islands follow the newer reef reference: irregular warm sandy coasts, fading turquoise seabeds, broken animated surf, layered slate rocks, clustered curved palms and undergrowth. Offshore landmarks vary between carved ruins, cliffs and palm groves. Harbor cottages sit within planted rocky backdrops while paths and wooden docks remain clear. Small surface grain, deck seams and detailed open-water normals remain absent. Wakes use two restrained curved ribbons sampled from actual movement. Mage carries an upright violet crystal; Gunboat cannon/harpoon fittings aim at their targets. Fish are subdued submerged forms, with no overhead markers. References are documentation only, never gameplay art.
...
Offshore islands use four radius bands: small islets (80–115), medium islands (165–235), large landmasses (290–360) and giant islands (520–720), chosen with 35%/35%/15%/15% candidate weights. Giants reach twice the previous maximum radius. Radius describes the longest land reach. Eight seeded profiles—compact, long, crescent, lobed, headland, bean, twin-lobe and scalloped—vary width, lean, rotation, relief and coastal guides. A continuous curve rounds the guides before terrain and collision share the resulting 192-point outline; broad bays replace tight V-shaped cuts. Larger neighbors receive extra clearance across two rings of chunks, with an explicit clearance check around home. Giant islands gain more inland vegetation and rocks while beach and shallow-water depths stay bounded, preserving sparse sailing routes. See the [variety goal and follow-up](docs/ISLAND_VARIETY_GOAL.md).

`art-sample.tscn` is a separate native art proof containing a boat, crab, cottage, island and water. Run it with `./run.command art-sample.tscn`. Tab switches inspection scale; Space cycles eight coastline families; V finds the next seeded variant of the current family; R cycles radii 95, 200, 330 and 720; F12 saves a timestamped rendered frame under `evidence/` with its profile, size and seed. At radius 720, the island moves toward the center, the boat moves aside and the harbor/crab are hidden; camera and boat scale stay unchanged. It contains no gameplay voyage or injected state.
...
Occasional floating barrels break on boat contact for 3–6 run gold. Only 20% of offshore chunks propose a single barrel; shore/encounter clearance and a 900-unit minimum spacing reduce that further. Barrels have no chart icon or overhead marker. Rare treasure appears on the beach edges of about 15% of offshore islands, with a clear patch and a subtle golden glint. Approach from the water to collect 35–55 gold. Home waters have no guaranteed loot. Both pickups show a brief local gold number and remain depleted when chunks reload; collected chests disappear from the chart. Neither awards silver. See the [sparse rewards goal](docs/OCEAN_REWARDS_GOAL.md).
...
Beach treasure has a rounded metal-banded lid, floating barrels have curved wooden staves and two dark hoops, and fishing schools use five subdued fish. Offshore islands and harbors are sparse seeded landmarks, scattered widely across chunks rather than centered in rows. Islands vary in size, orientation, elongation and curved outline, from narrow islets to broad bean-shaped land. Sand, fading shallow water, moving surf, chart silhouettes and island collision share one seeded shoreline. Island props fit the available land with uniform scale so palms and carved stones retain their proportions. Rocks and palms fit within that footprint. Harbor layouts retain their established dock geometry. Only 42% of chunks propose a landmark, and nearby proposals are thinned to maintain at least 900 units between centers. Harbors are randomly selected landmarks rather than a fixed lattice. Shore rocks stay clustered around islands; fishing and encounter placement checks neighboring shores for clearance. The starting home layout remains fixed.

Friendly shot trails and hit particles are subdued and brief; coral boss bombs arc above the water before bursting at their landing points. Weapon fittings reflect equipped weapons and ranks; whirlpool art uses the exact attack radius, and harpoon ropes strengthen with pull upgrades. Soaked status, its slowing effect and its damage bonuses have been removed entirely.
