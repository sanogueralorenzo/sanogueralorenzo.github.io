...
Sell catches for gold, repair, and buy weapons or stat upgrades at harbors. Combat levels offer three varying free upgrades. There are no prerequisite trees or permanent stat grind. Every ten monster kills in a voyage earn one silver, saved immediately between voyages; incomplete groups reset with the voyage, and existing silver is retained; silver spending is reserved for a future update. A new voyage resets catches, money, and equipment; silver, settings, best kill count, and completed-voyage count persist locally. The horizontal top-left counters use code-drawn clock, silver coin, gold coin and skull icons for combat time (scaled by game speed and frozen during fishing/pauses), saved silver, current-run gold, and kills.
