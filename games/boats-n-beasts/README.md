...
The title backdrop frames the home cottage upper-left, the island lower-right and the boat to the left, leaving open water behind the centered logo and buttons. Menu scenery uses the home chunk; encounter props appear when sailing begins. Title and pause actions share inset navy/turquoise buttons, a gold keyboard-focus outline, and original code-drawn sail, key, chart, chest, book and home icons. Menus use compact navy panels, cream text, turquoise selection and gold purchase controls. Harbor and level-up offers share three equal cards with original code-drawn symbols and concise benefits. Hover motion and purchase pulses provide brief feedback.
