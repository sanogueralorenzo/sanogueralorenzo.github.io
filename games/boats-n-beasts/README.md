...
Sail over floating treasure for 12–20 run gold. Each chest is collected automatically once per location per run, disappears from the chart after collection, and remains depleted when chunks reload. The home waters include one chest; farther discoveries vary by seed. Treasure does not award silver.
