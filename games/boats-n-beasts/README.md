...
Sell catches for gold, repair, and buy weapons or stat upgrades at harbors. Combat levels offer three varying free upgrades. There are no prerequisite trees or permanent stat grind. Each monster kill earns one silver, saved immediately between voyages; silver spending is reserved for a future update. A new voyage resets catches, money, and equipment; silver, settings, best kill count, and completed-voyage count persist locally. The top-left counters show combat time (scaled by game speed and frozen during fishing/pauses), saved silver, current-run gold, and kills.
