...
This is still a foundation, not the completed game. Richer terrain grammar, sandboard animation and contact physics, authored rocks and gaps, environmental audio, effects, accessibility, long-session streaming/performance soaks, and external playtest validation remain required.
