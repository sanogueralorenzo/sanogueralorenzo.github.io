...
- A graded high-desert sky, lower warm sunlight, readable cool shadow fill, smoother mountain geometry, a restrained alpine-and-sand palette, original high-detail albedos at believable ground scale, lit stone landmarks, directional slope shading, SSAO, and a denser fine-grain surface wake keep slopes and motion readable without changing the Forward+ renderer configuration. Restrained texture mixing preserves material detail without muddying large terrain forms, while rotated secondary world-space sampling remains continuous across streamed chunk seams.
