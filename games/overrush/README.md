...
- Board pitch and bank, biome-aware surface spray, a bounded terrain-conforming carve track, contact bursts, continuous speed wind, crossfaded sand/grass board contact, synthesized jump/landing cues, and a restrained HUD communicate speed, chosen lines, contacted terrain, landing quality, and boost state. The track breaks across airtime, follows floating-origin rebases, fades behind the rider, and clears at the summit rather than bridging gaps or growing forever. Contact audio falls silent in the air while wind carries momentum; pause and crashes silence all motion loops.
