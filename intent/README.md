...
grants, constrained capability, effect, and context argument types,
verification purity, and
memory retention lifecycles, accepts `require` and `deny` invariants, and emits
versioned JSON
