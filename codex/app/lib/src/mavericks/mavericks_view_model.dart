...
///   ExampleViewModelImpl({required ExampleRepository repository})
...
///       task: _repository.getExampleTodo,
...
abstract class MavericksViewModel<S extends MavericksState<S>> {
  ...
  /// Example:
  /// ```dart
  /// setState((state) => state.copyWith(todo: const Loading()));
  /// ```
  ///
  ...
  /// Example:
  /// ```dart
  /// setState((state) => state.copyWith(todo: const Uninitialized()));
  /// final todo = withState((state) => state.todo);
  /// ```
  @protected
  ...
  /// Example:
  /// ```dart
  /// final todo = withState((state) => state.loadedTodo);
  /// ```
  ///
  ...
  /// ```dart
  /// onEach(
  ///   (state) => state.loadedTodo,
  ///   (todo) => _analytics.logTodoVisible(todo?.id),
  /// );
  /// ```
  ///
  ...
  /// Example:
  /// ```dart
  /// setOnEach<ExampleTodo>(
  ///   repository.todoStream,
  ///   (state, todo) => state.copyWith(todo: Success(todo)),
  /// );
  /// ```
  ///
  ...
  /// onAsync<ExampleTodo>(
  ///   (state) => state.todo,
  ///   onSuccess: (todo) => _analytics.logLoaded(todo.id),
  ///   onFail: (error) => _analytics.logLoadFailure(error),
  /// );
  /// ```
  ///
