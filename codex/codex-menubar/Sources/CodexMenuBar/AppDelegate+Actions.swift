...
extension AppDelegate {
  ...
  @objc func setAutoRemoveSelection(_ sender: NSMenuItem) {
    ...
    applyAutoRemoveSettings(autoRemoveSettings.withSelection(days: days, mode: mode))
  }
  ...
  private nonisolated static func makeAutoRemovePassHandler(
    ...
    {
      runAutoRemovePass(sessionsCLI: sessionsCLI, olderThanDays: olderThanDays, mode: mode)
    }
  }
