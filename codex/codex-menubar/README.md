...
- `Agents -> Settings…` shows `Home Project Folder` and `GitHub Repos` sections.
- `Agents -> Settings…` shows `Loading GitHub Repositories` with a spinner, then switches to the repo hint after load completes.
