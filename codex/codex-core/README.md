...
- Agents commands:
  ...
  - Primary verbs: `config init|show|available-repos|available-projects|set-allowed-repos|set-allowed-projects|set-project-repo-mappings|set-review-mode|clear-allowed-repos|clear-allowed-projects|clear-project-repo-mappings`, `task list|run|jobs|show`, `worker start|loop`, `review list|run|jobs|show`.
