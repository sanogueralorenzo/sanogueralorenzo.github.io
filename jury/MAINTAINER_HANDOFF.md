...
Add a key-policy-backed downstream verifier fixture for signed code-change adoption bundles so consumers can verify producer identity without wiring raw public-key flags in every workflow.
