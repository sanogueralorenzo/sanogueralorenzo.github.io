...
- [examples/ci/jury-npm-publish.yml](examples/ci/jury-npm-publish.yml): release workflow example where npm publication depends on the package manifest check, package release evidence fixture validation, and a downloaded dry-run publication record.
...
Add release evidence artifact upload guidance for package rollback and replacement audits.
