...
- [ ] Confirm publication CI replays `archive-drift-remediation-audit-handoff.json` against the retained manifest and remediation audit before replay summary generation and `dry-run-publication`.
...
- [ ] If replay summary diagnostics retention handoff CI replay enforcement fails, use [TROUBLESHOOTING.md](TROUBLESHOOTING.md) to check the publication workflow ordering and replay the generated handoff against retained archive evidence locally.
- [ ] If the remediation audit handoff schema fails, use [TROUBLESHOOTING.md](TROUBLESHOOTING.md) to inspect `schema_version`, retained companion files, failed and replacement package versions, drift evidence, restored evidence, verification commands, workflow run id, source revision, approver, and approval time.
- [ ] If remediation audit handoff CI workflow enforcement fails, use [TROUBLESHOOTING.md](TROUBLESHOOTING.md) to check publication workflow ordering and replay `archive-drift-remediation-audit-handoff.json` locally against retained failed and replacement archive evidence.
...
- [ ] Store [archive-drift-remediation-audit-handoff.json](examples/ci/fixtures/package-release/archive-drift-remediation-audit-handoff.json) with the retained failed and replacement archives before closing remediation.
...
- [examples/code-change-adoption/README.md](examples/code-change-adoption/README.md)
- [examples/code-change-adoption/verdict.retry.json](examples/code-change-adoption/verdict.retry.json)
- [examples/code-change-adoption/gate.retry.json](examples/code-change-adoption/gate.retry.json)
- [examples/code-change-adoption/review-bundle.retry.json](examples/code-change-adoption/review-bundle.retry.json)
- [examples/code-change-adoption/verdict.accept.json](examples/code-change-adoption/verdict.accept.json)
- [examples/code-change-adoption/gate.accept.json](examples/code-change-adoption/gate.accept.json)
- [examples/code-change-adoption/review-bundle.accept.json](examples/code-change-adoption/review-bundle.accept.json)
