...
- `review-bundle.accept.v1.json`: a portable bundle containing the claim, check, evidence, verdict, producer metadata, and provenance needed to recreate a CI gate result.
