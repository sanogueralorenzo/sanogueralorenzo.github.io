...
materials: Walking map, library hours, corner-store receipts from visits that never happened, and a rental note with three underlined streets.
provenance: Built from saved listings and repeated map searches for a move that stayed imaginary.
question: How long does it take for a place to invent your habits, and what happens to the version it almost trained?
permalink: /unmade/neighborhood-that-would-have-known-you/
---

The neighborhood had enough friction to change a person gently: a longer walk for groceries, a louder bus stop, fewer familiar shortcuts, more accidental greetings. Its streets suggested a different pace without making any dramatic promise.
