...
swiftc "$clipboard_root/ClipboardHistory.swift" "$clipboard_root/ClipboardFormats.swift" "$clipboard_root/ClipboardMenu.swift" "$clipboard_root/tests/ClipboardSearchTests.swift" -o "$test_dir/search-tests"
