...
Palette's core loop is copy → find by source app → reuse. Use one compact corner panel, native platform behavior, useful text/image/link/file previews, simple search, and dependable copy/paste. Preserve the dark lavender identity and overlapping-squares icon. Secondary actions should appear only when needed.
