...
Use tools to inspect and verify rather than guess. Prefer rg and rg --files. Run independent work in parallel; keep dependent work and mutations sequential. Keep shell calls safe and readable: omit output-label separators, quote shell input carefully, avoid blocking waits over 60 seconds, and never repurpose HOME or CODEX_HOME.
