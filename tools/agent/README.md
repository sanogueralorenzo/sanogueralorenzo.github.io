...
Agent is one local runtime shared by its CLI, Telegram gateway, and native macOS client. It owns routing, sessions, memory, tools, recovery, and client protocol.
