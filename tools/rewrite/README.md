...
Choose **Shortening** in the pencil menu to control the rewrite length. **Light** is the default; Medium, Strong, and Maximum target progressively shorter results.
