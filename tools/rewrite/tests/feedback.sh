...
cd "$rewrite_root"
mkdir -p build/tests
swiftc -parse-as-library Sources/Editing.swift Sources/ResultNotice.swift Sources/MenuBarStatus.swift Sources/Shortcut.swift tests/FeedbackRuntime.swift \
