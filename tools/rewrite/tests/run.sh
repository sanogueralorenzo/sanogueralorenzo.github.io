...
swiftc -parse-as-library Sources/Editing.swift Sources/ShorteningLevel.swift Sources/RewriteClipboard.swift Sources/SelectedText.swift Sources/RewriteProvider.swift \
