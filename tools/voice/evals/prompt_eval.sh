...
MODEL_URL_DEFAULT="https://huggingface.co/litert-community/Qwen3-0.6B/resolve/main/Qwen3-0.6B_dynamic_wi4b32_afp32.litertlm"
...
MODEL_PATH="${CACHE_DIR}/models/Qwen3-0.6B_dynamic_wi4b32_afp32.litertlm"
