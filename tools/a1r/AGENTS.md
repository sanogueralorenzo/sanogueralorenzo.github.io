...
- A1R is pre-release. When behavior changes, delete the replaced implementation, flags, aliases, migrations, compatibility branches, tests, and copy instead of preserving them.
...
- Keep all clients thin and make the shared A1R runtime the sole owner of sessions, memory, routing, tools, and recovery.
