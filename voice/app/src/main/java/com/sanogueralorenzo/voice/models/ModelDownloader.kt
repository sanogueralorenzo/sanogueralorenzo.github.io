...
class ModelDownloader(private val context: Context) {
    ...
    fun download(
        ...
        executor.execute {
            val result = downloadInternal(spec, onProgress)
    ...
    private fun downloadInternal(spec: ModelSpec, onProgress: (Int) -> Unit): ModelDownloadResult {
        // Treat already-available (asset or verified file) as success from the UI standpoint.
        val alreadyReady = ModelStore.ensureModelFile(context, spec) != null
